...
public interface Server
{
	...
	/**
	 * Um einen User beim Server zu registrieren. Ist der gewuenschte Login-Name bereits vergeben, wird eine KeyAlreadyExistsException geworfen.
	 * 
	 * @param login
	 *            Der Login-Name.
	 * @param pw
	 ...
	 * @return Eine {@link Session} fuer den User.
	 * @throws ServerException
	 */
