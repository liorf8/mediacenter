 ...
 * �bergeben (<code>""</code>). Für den Standard-Ordner "Music" <code>"/Music"</code>.
 * 
 * @author mhertram
 * 
 */
public interface Session
{
	 ...
	 */
	public void changeLogin(String newLogin, String pw) throws AuthenticationException, KeyAlreadyExistsException, ServerException;
	 ...
	 * @throws ServerException
	 */
	public void changePw(String newPw, String currentPw) throws AuthenticationException, ServerException;
	 ...
	 * @return Die Anzahl der tats�chlich gelöschten Dateien.
	 * @throws FileSystemException
	 *             Bei IO-Fehlern.
	 * @throws ServerException
	 */
