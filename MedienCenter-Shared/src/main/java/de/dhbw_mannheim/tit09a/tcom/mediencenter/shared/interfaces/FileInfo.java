...
public abstract class FileInfo
{
	...
	/**
	 * Der Boolean-Wert gibt an, ob die Datei vom Anwender modifiziert werden kann. Beispielsweise k�nnen die Standard-Ordner (Music, Pictures,
