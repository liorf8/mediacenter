...
import de.dhbw_mannheim.tit09a.tcom.mediencenter.desktopclient.test.app.MediaListPlayerEventListenerImpl;
import de.dhbw_mannheim.tit09a.tcom.mediencenter.desktopclient.test.app.MediaPlayerEventListenerImpl;
...
public class VLCController
{
	...
	if (initIfNotAlready)
	{
	    ...
	    videoSurface = mediaPlayerFactory.newVideoSurface(Frame.getInstance()
		    .getVideoCanvas());
    ...
    {
	Frame.getInstance().setGUIForPlayMedia(mrl);
