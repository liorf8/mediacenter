...
public class TranscodingCategoryPanel extends CategoryPanel
{
	...
	public Map<String, Object> getValueComponents()
	{
		...
		valueComponents.put(Settings.KEY_STREAMING_TRANSCODING_VIDEO_KBIT_RATE, spnrVideoKBitRate);
		valueComponents.put(Settings.KEY_STREAMING_TRANSCODING_AUDIO_KBIT_RATE, spnrAudioKBitRate);
	...
	protected JPanel createCategoryPanel()
	{
		...
		cmbBxVideoCodec.addItem("H263");
		cmbBxVideoCodec.addItem("X264");
		cmbBxVideoCodec.addItem("WMV1");
		cmbBxVideoCodec.addItem("WMV2");
		cmbBxVideoCodec.addItem("DVX1");
		cmbBxVideoCodec.addItem("DVX2");
		cmbBxVideoCodec.addItem("DVX3");
		...
		SpinnerModel spnrMdl = new SpinnerNumberModel(0, 0, 64 * 1024, 1); // 3072
		...
		spnrMdl = new SpinnerNumberModel(0, 0, 1024, 1);
