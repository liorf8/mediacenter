...
@SimonRemote(value = { MediaMetaRemote.class })
public class MediaMetaRemoteImpl implements Serializable, MediaMetaRemote, SimonUnreferenced
{
	...
	public MediaMetaRemoteImpl(MediaMeta nativeMediaMeta)
	{
	...
	{
		throw new UnsupportedOperationException("BufferedImage is not serializable! Load the image on client side via getArtWorkUrl() or getArtworkBytes()");
	}
