...
public class InfoPlayerImpl implements InfoPlayer, Serializable
{
	...
	// --------------------------------------------------------------------------------
	@Override
	public synchronized MediaMetaRemote getMediaMeta(String path) throws ServerException, FileSystemException
	{
		checkValid();
		try
		{
			...
			return new MediaMetaRemoteImpl(headlessPlayer.getMediaMeta());
		}
		catch (FileSystemException e)
		{
			ServerMain.INVOKE_LOGGER.info("User " + this + " caused throw of:", e);
